...
#making a set of distinct words
vocab = set()
...
#Making a dictionary from the set
Dict = {}
i = 0
for word in vocab:
    Dict[word] = i
...
#p_x_y0[i] = probability of word[i] in the dictionary to belong to class 0
#p_x_y4[i] = probability of word[i] in the dictionary to belong to class 4
...
#function to find in which class a sentiment lies
def test_MLA(tweet):
    p0 = np.log(p_y0)
    p4 = np.log(p_y4)    
    index = 0
...
print("Accuracy of test is: ", accuracy(test_list_new, data_test))
